...
public class Enemy : MonoBehaviour
{
    ...
    public Action<EnemySkillypes> OnUseSkill;
    ...
    private float waitingToMoveTimerMax = 5f;
    ...
    private EnemySkillypes currentSkill;
    private List<Transform> enemySkillList;

    private float powerScale;

    private Vector3[] moveablePositionList = { new Vector3(9.3f, 2.5f, 0), new Vector3(6.3f, 2.5f, 0), 
        new Vector3(9.3f, 0, 0), new Vector3(6.3f, 0, 0), 
        new Vector3(9.3f, -3.7f, 0), new Vector3(6.3f, -3.7f, 0), 
        new Vector3(0, 0, 0) };
    ...
    private void Update()
    {
        switch (state)
        {
            ...
            case State.WaitingToMove:
                ...
                {
                    newPosition = moveablePositionList[UnityEngine.Random.Range(0, moveablePositionList.Length - 1)];
                    state = State.Move;
                }
                break;
            case State.Move:
